...
func (_PermittedNetworkManagement *PermittedNetworkManagementCaller) ExistingAccessibleNetworks(opts *bind.CallOpts) (uint16, error) {
	var out []interface{}
	err := _PermittedNetworkManagement.contract.Call(opts, &out, "existingAccessibleNetworks")
...
//
// Solidity: function existingAccessibleNetworks() view returns(uint16)
func (_PermittedNetworkManagement *PermittedNetworkManagementSession) ExistingAccessibleNetworks() (uint16, error) {
	return _PermittedNetworkManagement.Contract.ExistingAccessibleNetworks(&_PermittedNetworkManagement.CallOpts)
}

// ExistingAccessibleNetworks is a free data retrieval call binding the contract method 0x35fb246b.
//
// Solidity: function existingAccessibleNetworks() view returns(uint16)
func (_PermittedNetworkManagement *PermittedNetworkManagementCallerSession) ExistingAccessibleNetworks() (uint16, error) {
	return _PermittedNetworkManagement.Contract.ExistingAccessibleNetworks(&_PermittedNetworkManagement.CallOpts)
}
...
// GetAlltheKeysInMapping is a free data retrieval call binding the contract method 0x51fa5ea5.
//
// Solidity: function getAlltheKeysInMapping() view returns(uint256[])
func (_PermittedNetworkManagement *PermittedNetworkManagementCaller) GetAlltheKeysInMapping(opts *bind.CallOpts) ([]*big.Int, error) {
	var out []interface{}
	err := _PermittedNetworkManagement.contract.Call(opts, &out, "getAlltheKeysInMapping")
...
//
// Solidity: function getAlltheKeysInMapping() view returns(uint256[])
func (_PermittedNetworkManagement *PermittedNetworkManagementSession) GetAlltheKeysInMapping() ([]*big.Int, error) {
	return _PermittedNetworkManagement.Contract.GetAlltheKeysInMapping(&_PermittedNetworkManagement.CallOpts)
}

// GetAlltheKeysInMapping is a free data retrieval call binding the contract method 0x51fa5ea5.
//
// Solidity: function getAlltheKeysInMapping() view returns(uint256[])
func (_PermittedNetworkManagement *PermittedNetworkManagementCallerSession) GetAlltheKeysInMapping() ([]*big.Int, error) {
	return _PermittedNetworkManagement.Contract.GetAlltheKeysInMapping(&_PermittedNetworkManagement.CallOpts)
}
