...
// AccessibleNetworkManagementContractAccessibleNetwork is an auto generated low-level Go binding around an user-defined struct.
type AccessibleNetworkManagementContractAccessibleNetwork struct {
	NetworkName         string
	NetworkIP           string
...
func (_AccessibleNetworkManagement *AccessibleNetworkManagementCaller) GetAccessibleNetwork(opts *bind.CallOpts, accessibleNetworkId *big.Int) (AccessibleNetworkManagementContractAccessibleNetwork, error) {
	var out []interface{}
	err := _AccessibleNetworkManagement.contract.Call(opts, &out, "getAccessibleNetwork", accessibleNetworkId)

	if err != nil {
		return *new(AccessibleNetworkManagementContractAccessibleNetwork), err
	}

	out0 := *abi.ConvertType(out[0], new(AccessibleNetworkManagementContractAccessibleNetwork)).(*AccessibleNetworkManagementContractAccessibleNetwork)
...
//
// Solidity: function getAccessibleNetwork(uint256 accessibleNetworkId) view returns((string,string,string,string,uint256))
func (_AccessibleNetworkManagement *AccessibleNetworkManagementSession) GetAccessibleNetwork(accessibleNetworkId *big.Int) (AccessibleNetworkManagementContractAccessibleNetwork, error) {
...
//
// Solidity: function getAccessibleNetwork(uint256 accessibleNetworkId) view returns((string,string,string,string,uint256))
func (_AccessibleNetworkManagement *AccessibleNetworkManagementCallerSession) GetAccessibleNetwork(accessibleNetworkId *big.Int) (AccessibleNetworkManagementContractAccessibleNetwork, error) {
	return _AccessibleNetworkManagement.Contract.GetAccessibleNetwork(&_AccessibleNetworkManagement.CallOpts, accessibleNetworkId)
}
...
func (_AccessibleNetworkManagement *AccessibleNetworkManagementCaller) GetAllAccessibleNetworks(opts *bind.CallOpts) ([]AccessibleNetworkManagementContractAccessibleNetwork, error) {
	var out []interface{}
...
//
// Solidity: function getAllAccessibleNetworks() view returns((string,string,string,string,uint256)[])
func (_AccessibleNetworkManagement *AccessibleNetworkManagementSession) GetAllAccessibleNetworks() ([]AccessibleNetworkManagementContractAccessibleNetwork, error) {
...
//
// Solidity: function getAllAccessibleNetworks() view returns((string,string,string,string,uint256)[])
func (_AccessibleNetworkManagement *AccessibleNetworkManagementCallerSession) GetAllAccessibleNetworks() ([]AccessibleNetworkManagementContractAccessibleNetwork, error) {
	return _AccessibleNetworkManagement.Contract.GetAllAccessibleNetworks(&_AccessibleNetworkManagement.CallOpts)
}
